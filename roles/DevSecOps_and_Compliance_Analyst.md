...
## Role purpose
The DevSecOps & Compliance Analyst owns the security controls, audit trail, operational evidence, and compliance documentation for this system. This role makes sure the application is not only functional, but also observable, defensible, and reviewable.
...
- `carigara/settings.py` configures `django-axes`, authentication backends, production security flags, and logging.
