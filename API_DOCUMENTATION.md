# Municipality of Carigara, Leyte API Documentation
...
This application uses JWT (JSON Web Tokens) for API authentication. Include the token in the Authorization header:
  ...
  "results": [
    {
      ...
      "reported_by": {
        "id": 2,
        "username": "dispatcher",
        "email": "dispatcher@carigara.local",
        "role": "dispatcher"
      },
