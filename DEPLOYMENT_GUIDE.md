...
5. Configure:
   ...
   - **Start Command**: `gunicorn carigara.wsgi:application --bind 0.0.0.0:$PORT`
...
2. Set "Start Command":
```
gunicorn carigara.wsgi:application --bind 0.0.0.0:$PORT
```
...
Update `carigara/settings.py` for production:
...
**Postman Collection**: [Import Carigara_API_Collection.postman_collection.json]
